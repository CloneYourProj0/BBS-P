          ...
          if (result.code === 0) {
            ...
            layer.open({
              ...
              yes: function(index, layero){
                ...
                // 触发表单提交
                layero.find('.layui-layer-btn0').attr('lay-filter', 'submitBot').click();
              },
              btn2: function(index, layero){
                // 取消按钮回调
              },
